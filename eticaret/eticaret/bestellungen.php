...
if (isset($_GET['q'])) {
    ...
    $pdf->Cell(0, 10, 'Sipariş No: ' . $siparis_no, 0, 1, 'R');
    ...
    $pdf->Ln();
    $pdf->Cell(0, 10, 'Sipariş No: ' . $siparis_no, 0, 1);
    ...
    foreach ($urunler as $urun) {
        ...
        $pdf->Cell(30, 10, number_format($urun['BIRIM_FIYAT'], 2) . ' CHF', 1);
        $pdf->Ln();
    }
    ...
    $pdf->Output('teslimat_onayi_' . $siparis_no . '.pdf', 'D');
} else {
    die("Sipariş numarası verilmedi.");
}
?>
