...
<body>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-4">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Kumaş Düzenle</h5>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                                <div class="mb-3">
                                                    <label for="mainCategorySelect" class="form-label">Kumaş Seç</label>
                                                    <select class="form-select" id="mainCategorySelect" aria-label="Default select example">
                                                        <option selected="">Lütfen bir kumaş seçin</option>
                                                        <?php foreach ($anaKategoriler as $anaKategori): ?>
                                                            <option value="<?php echo $anaKategori['KUMAS_CINSI']; ?>"><?php echo $anaKategori['KUMAS_CINSI']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="mainCategoryNewName">Yeni Kumaş Adı</label>
                                                    <input type="text" class="form-control" id="mainCategoryNewName" placeholder="Kumaş Adı">
                                                </div>
    ...
    <script src="assets/js/fabricupdate.js"></script>
    <script src="assets/js/fabricdelete.js"></script>
</body>
</html>
