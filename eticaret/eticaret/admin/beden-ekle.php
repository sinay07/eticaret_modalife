...
<body>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-4">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Beden Ekle</h5>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                                <div class="mb-3">
                                                    <label for="bedenSelect" class="form-label">Mevcut Bedenler</label>
                                                    <select class="form-select" id="bedenSelect" aria-label="Default select example">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="bedenAdi">Beden Adı</label>
                                                    <input type="text" class="form-control" id="bedenAdi" placeholder="Beden Adı">
                                                </div>
                                                <input type="button" id="addSizeButton" class="btn btn-primary" value="Ekle">
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="assets/js/addsize.js"></script>
</body>
</html>
